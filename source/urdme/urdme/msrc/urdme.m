function umod = urdme(workdir,workerid,umod,varargin)
%workdir and wokerid were added for parallel use, 
%and the following illustration about this function is for the original version
%without these two input variables:
%umod = urdme(umod,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%added adaptation to original urdme for parallel use
...
if umod.compile
  ...
  feval(['mexmake_' umod.solver],workdir,workerid,umod.propensities,umod.makeargs{:});
else
